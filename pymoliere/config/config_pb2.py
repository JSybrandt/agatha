...
_TEXTPARSERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_sentence_len', full_name='pymoliere.TextParserConfig.min_sentence_len', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_sentence_len', full_name='pymoliere.TextParserConfig.max_sentence_len', index=4,
...
_CONSTRUCTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='debug_sample_rate', full_name='pymoliere.ConstructConfig.debug_sample_rate', index=4,
      number=6, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='db', full_name='pymoliere.ConstructConfig.db', index=5,
